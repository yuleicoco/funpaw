...
@interface ZdFriendModel : JSONModel
...
@property (nonatomic,copy)NSString <Optional> * gz;
...
@property (nonatomic,copy)NSString <Optional> * sprouts;
...
@property (nonatomic,copy)NSString <Optional> * fs;
