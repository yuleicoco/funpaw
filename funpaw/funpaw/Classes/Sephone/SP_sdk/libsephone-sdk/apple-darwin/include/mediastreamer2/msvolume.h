...
#define MS_VOLUME_SET_EA_DOWNSPEED		MS_FILTER_METHOD(MS_VOLUME_ID,20,float)

#define MS_VOLUME_SET_NOISE_GATE_SUSTAIN		MS_FILTER_METHOD(MS_VOLUME_ID,21,float)
