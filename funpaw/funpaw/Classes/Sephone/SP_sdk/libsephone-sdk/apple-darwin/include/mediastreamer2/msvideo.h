...
//@ xr 2016/6/2 wqcif宽改为qcif一致，可使用downscale参数，直接取1/2视频采集尺寸。
// wqcif宽必须为16的倍数，因为deinterlace_down_scale_neon步进为16。
// 原值216导致android下旋转后crash。ios压根就不能工作。
...
//@ xr 2016/8/24 2秒一帧，降低带宽需求。
//@ xr 2016/9/21 还是1秒一帧流畅度更好。
